# python generate_tfrecord.py annotations/train_labels.csv annotations/label_map.pbtxt images/ annotations/train.record
# python generate_tfrecord.py annotations/test_labels.csv annotations/label_map.pbtxt images/ annotations/test.record
...
def class_dict_from_pbtxt(pbtxt_path):
    # open file, strip \n, trim lines and keep only lines beginning with id or display_name
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Vytvorenie TFRecord suboru',
                                     formatter_class=argparse.RawDescriptionHelpFormatter)
    parser.add_argument('csv_input', metavar='csv_input', type=str, help='Cesta k csv suboru')
    parser.add_argument('pbtxt_input', metavar='pbtxt_input', type=str,
                        help='Cesta k pbtxt suboru obsahujuceho id a nazvy tried')
    parser.add_argument('image_dir', metavar='image_dir', type=str, help='Cesta k precinku so vsetkymi obrazkami')
    parser.add_argument('output_path', metavar='output_path', type=str, help='Cesta k vystupnemu TFRecord suboru')
    ...
    print('Uspesne vytvoreny TFRecord subor: {}'.format(output_path))
